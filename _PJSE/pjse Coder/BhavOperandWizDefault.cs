...
namespace pjse.BhavOperandWizards.WizDefault
{
    ...
    internal class UI : Window, iBhavOperandWizForm
	{
		...
		private TextBoxCompat tbInst_Op01_dec;
		...
		private TextBoxCompat tbInst_Op23_dec;
		private LabelCompat label2;
		internal StackPanel pnWizDefault;
		/// <summary>
		...
		public UI()
		{
			...
			TextBoxCompat[] iow = { tbInst_Op01_dec, tbInst_Op23_dec };
        ...
        public StackPanel WizPanel { get { return this.pnWizDefault; } }
		...
		{
                        this.pnWizDefault = new StackPanel();
            this.tbInst_Op01_dec = new TextBoxCompat();
            ...
            this.tbInst_Op23_dec = new TextBoxCompat();
            this.label2 = new LabelCompat();            //
            // pnWizDefault
            //
            this.pnWizDefault.Children.Add(this.tbInst_Op01_dec);
            this.pnWizDefault.Children.Add(this.label13);
            this.pnWizDefault.Children.Add(this.tbInst_Unk7);
            this.pnWizDefault.Children.Add(this.tbInst_Unk6);
            this.pnWizDefault.Children.Add(this.tbInst_Unk5);
            this.pnWizDefault.Children.Add(this.tbInst_Unk4);
            this.pnWizDefault.Children.Add(this.tbInst_Unk3);
            this.pnWizDefault.Children.Add(this.tbInst_Unk2);
            this.pnWizDefault.Children.Add(this.tbInst_Unk1);
            this.pnWizDefault.Children.Add(this.tbInst_Unk0);
            this.pnWizDefault.Children.Add(this.tbInst_Op7);
            this.pnWizDefault.Children.Add(this.tbInst_Op6);
            this.pnWizDefault.Children.Add(this.tbInst_Op5);
            this.pnWizDefault.Children.Add(this.tbInst_Op4);
            this.pnWizDefault.Children.Add(this.tbInst_Op3);
            this.pnWizDefault.Children.Add(this.tbInst_Op2);
            this.pnWizDefault.Children.Add(this.tbInst_Op1);
            this.pnWizDefault.Children.Add(this.tbInst_Op0);
            this.pnWizDefault.Children.Add(this.tbInst_Op23_dec);
            this.pnWizDefault.Children.Add(this.label2);            this.pnWizDefault.Name = "pnWizDefault";
            //
            // tbInst_Op01_dec
            //            this.tbInst_Op01_dec.Name = "tbInst_Op01_dec";
            this.tbInst_Op01_dec.LostFocus += (s, e) => this.dec16_Validated(s, e);
            // label13
            ...
            this.tbInst_Op23_dec.LostFocus += (s, e) => this.dec16_Validated(s, e);
            // label2
		...
		{
			try { Convert.ToUInt16(((TextBoxCompat)sender).Text); }
			catch (Exception) { e.Cancel = true; }
		}

		private void dec16_Validated(object sender, System.EventArgs e)
		{
			ushort val = Convert.ToUInt16(((TextBoxCompat)sender).Text);
			...
			if (cv != val)
			{
				...
				((TextBoxCompat)this.alHex8[i]).Text = SimPe.Helper.HexString(inst.Operands[i]);
				inst.Operands[i+1] = (byte)((val >> 8) & 0xFF);
				((TextBoxCompat)this.alHex8[i+1]).Text = SimPe.Helper.HexString(inst.Operands[i+1]);
			}
		}
