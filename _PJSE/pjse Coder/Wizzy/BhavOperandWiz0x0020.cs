...
namespace pjse.BhavOperandWizards.Wiz0x0020
{
    ...
    internal class UI : Window, iBhavOperandWizForm
	{
        ...
        private CheckBoxCompat2 ckbNID;
        private CheckBoxCompat2 ckbTemp01;
        private CheckBoxCompat2 ckbOrigGUID;
		/// <summary>
        ...
        public void Execute(Instruction inst)
        {
            ...
            this.ckbOrigGUID.IsChecked = ops1_7[0];
            this.ckbNID.IsChecked = ops1_7[1];
            this.ckbTemp01.IsChecked = ops1_7[2];
		...
		public Instruction Write(Instruction inst)
		{
			if (inst != null)
			{
                ...
                Boolset ops1_7 = ops1[0x07];
                ops1_7[0] = this.ckbOrigGUID.IsChecked == true;
                ops1_7[1] = this.ckbNID.IsChecked == true;
                ops1_7[2] = this.ckbTemp01.IsChecked == true;
                ops1[0x07] = ops1_7;
            }
			return inst;
		}
		...
		{            this.pnWiz0x001f = new StackPanel();
            ...
            this.ckbNID = new CheckBoxCompat2();
            this.ckbOrigGUID = new CheckBoxCompat2();
            this.label2 = new LabelCompat();
            this.flowLayoutPanel2 = new FlowLayoutPanel();
            this.tbGUID = new TextBoxCompat();
            this.lbGUIDText = new LabelCompat();
            this.ckbTemp01 = new CheckBoxCompat2();            // pnWiz0x001f
            // 
            this.pnWiz0x001f.Children.Add(this.flowLayoutPanel1);            this.pnWiz0x001f.Name = "pnWiz0x001f";
            // flowLayoutPanel1
            // 
            this.flowLayoutPanel1.Children.Add(this.label1);
            this.flowLayoutPanel1.Children.Add(this.pnObject);
            this.flowLayoutPanel1.Children.Add(this.ckbNID);
            this.flowLayoutPanel1.Children.Add(this.ckbOrigGUID);
            this.flowLayoutPanel1.Children.Add(this.label2);
            this.flowLayoutPanel1.Children.Add(this.flowLayoutPanel2);
            this.flowLayoutPanel1.Children.Add(this.ckbTemp01);            this.flowLayoutPanel1.Name = "flowLayoutPanel1";
            // label1
            ...
            // flowLayoutPanel2
            // 
            this.flowLayoutPanel2.Children.Add(this.tbGUID);
            this.flowLayoutPanel2.Children.Add(this.lbGUIDText);            this.flowLayoutPanel2.Name = "flowLayoutPanel2";
            // tbGUID
