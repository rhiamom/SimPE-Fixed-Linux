...
namespace SimPe.Plugin
{
	...
	public class SurgeryTool2 : Interfaces.ITool
	{
		...
		internal SurgeryTool2(IWrapperRegistry reg, IProviderRegistry prov) 
		{
			this.reg = reg;
			this.prov = prov;
		...
		{
			// "Neighbourhood" (British spelling) matches the existing submenu so
			// this item drops into it instead of creating a parallel "Neighborhood"
			// submenu. PluginManager.LoadMenuItems parses the backslash-separated
			// segments as menu levels.
			return "Neighbourhood\\Theo's Alt Sim Surgery";
		}
